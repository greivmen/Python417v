...
#     if method != "GET":
#         return 'HTP/1.1 405 Method Not Allowed!\n\n', 405
#     if url not in URLS:
#         return 'HTP/1.1 404 Page Not Found!\n\n', 404
...
#     # bode = URLS.get(url, 'Error 404')
#     bode = geterate_content(code, url)
#     return (headers + bode).encode()
#
#
# def run():
...
# import sqlite3
#
# from DZpython1.DZp25 import writer
...
# persons = [
#     {"name": 'Алексей', "year": 18, "weight": 78.8},
